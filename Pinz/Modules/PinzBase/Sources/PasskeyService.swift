...
private extension PasskeyService {
    ...
    func debugStubCredentialJSON() -> String {
        let stub: [String: Any] = [
            "id": "c3R1Yi1jcmVkZW50aWFsLWlk",
            "rawId": "c3R1Yi1jcmVkZW50aWFsLWlk",
            "type": "public-key",
            "response": [
                "clientDataJSON": "e30=",
        ...
        let data = (try? JSONSerialization.data(withJSONObject: stub)) ?? Data()
