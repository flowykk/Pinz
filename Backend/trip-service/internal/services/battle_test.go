...
func TestStartBattle_HappyPath(t *testing.T) {
	...
	svc := NewTripService(nil, participantRepo, nil, nil, nil, mediaRepo, nil, nil, nil, nil, nil, nil, nil, nil, battleRepo, nil, nil, nil)
...
func TestSubmitBattleResult_HappyPath(t *testing.T) {
	...
	svc := NewTripService(nil, nil, nil, nil, nil, mediaRepo, nil, nil, nil, nil, nil, nil, nil, nil, battleRepo, nil, nil, nil)
...
func TestSubmitBattleResult_Errors(t *testing.T) {
	t.Run("unknown_battle", func(t *testing.T) {
		...
		svc := NewTripService(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, battleRepo, nil, nil, nil)
