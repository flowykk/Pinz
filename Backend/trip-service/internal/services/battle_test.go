...
func TestStartBattle_HappyPath(t *testing.T) {
	...
	svc := NewTripService(nil, participantRepo, nil, nil, nil, mediaRepo, nil, nil, nil, nil, nil, nil, nil, battleRepo, nil, nil, nil, nil, nil)
...
func TestStartBattle_NotEnoughMedia(t *testing.T) {
	...
	svc := NewTripService(nil, participantRepo, nil, nil, nil, mediaRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	_, err := svc.StartBattle(ctxWithUser("u1"), &pb.StartBattleRequest{TripId: "trip-1"})
	st, _ := status.FromError(err)
...
func TestSubmitBattleResult_HappyPath(t *testing.T) {
	...
	svc := NewTripService(nil, nil, nil, nil, nil, mediaRepo, nil, nil, nil, nil, nil, nil, nil, battleRepo, nil, nil, nil, nil, nil)
...
func TestSubmitBattleResult_Errors(t *testing.T) {
	t.Run("unknown_battle", func(t *testing.T) {
		...
		svc := NewTripService(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, battleRepo, nil, nil, nil, nil, nil)
...
func TestGetBestMemories_OnlyPositiveRating(t *testing.T) {
	...
	svc := NewTripService(nil, participantRepo, nil, nil, nil, mediaRepo, nil, pinRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
