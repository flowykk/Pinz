...
func TestRecommendations_Integration(t *testing.T) {
	...
	svc := NewTripService(tripRepo, participantRepo, inviteRepo, settingsRepo, nil, mediaRepo, nil, pinRepo, tagRepo, socialRepo, favRepo, geoRepo, nil, nil, nil, nil, nil, nil, nil)
