...
//go:generate go run go.uber.org/mock/mockgen@latest -destination=desired_place_repository_mock.go -package=mocks pinz/backend/auth-service/internal/services DesiredPlaceRepositoryInterface
