...
type TripClient interface {
	...
	AddMediaToPinStart(ctx context.Context, req *proto.AddMediaToPinStartRequest) (*proto.AddMediaToPinStartResponse, error)
	RequestPinMediaUploadUrls(ctx context.Context, req *proto.RequestPinMediaUploadUrlsRequest) (*proto.RequestPinMediaUploadUrlsResponse, error)
	CommitPinMediaUpload(ctx context.Context, req *proto.CommitPinMediaUploadRequest) (*proto.CommitPinMediaUploadResponse, error)
	ProcessPinMediaAddition(ctx context.Context, req *proto.ProcessPinMediaAdditionRequest) (*proto.ProcessPinMediaAdditionResponse, error)
	GetPinMediaAdditionReview(ctx context.Context, req *proto.GetPinMediaAdditionReviewRequest) (*proto.GetPinMediaAdditionReviewResponse, error)
	FinalizePinMediaAddition(ctx context.Context, req *proto.FinalizePinMediaAdditionRequest) (*proto.FinalizePinMediaAdditionResponse, error)
	CancelPinMediaAddition(ctx context.Context, req *proto.CancelPinMediaAdditionRequest) (*proto.CancelPinMediaAdditionResponse, error)
	RemoveMediaFromPin(ctx context.Context, req *proto.RemoveMediaFromPinRequest) (*proto.RemoveMediaFromPinResponse, error)
	// Pin Create (ТЗ 4.1, 4.6-4.11)
	CreatePinStart(ctx context.Context, req *proto.CreatePinStartRequest) (*proto.CreatePinStartResponse, error)
	RequestPinCreationUploadUrls(ctx context.Context, req *proto.RequestPinCreationUploadUrlsRequest) (*proto.RequestPinCreationUploadUrlsResponse, error)
	CommitPinCreationUpload(ctx context.Context, req *proto.CommitPinCreationUploadRequest) (*proto.CommitPinCreationUploadResponse, error)
	ProcessPinCreation(ctx context.Context, req *proto.ProcessPinCreationRequest) (*proto.ProcessPinCreationResponse, error)
